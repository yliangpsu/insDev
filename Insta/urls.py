...
from Insta.views import (PostView, PostDetail, PostCreateView, PostUpdateView, PostDeleteView, UserProfile, 
                        EditProfile, addLike, addComment, toggleFollow, ExploreView)
